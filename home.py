...
def basicPageSetup(pageNo):
    ...
    back_img = tk.PhotoImage(file= r"C:\IV-II-Project\Crime-Detection\img\back.png")
...
def selectMultiImage(opt_menu, menu_var):
    ...
    if(len(path_list) < 5):
        ...
        back_img = tk.PhotoImage(file="C:\\IV-II-Project\\Crime-Detection\\img\\previous.png")
        next_img = tk.PhotoImage(file="C:\\IV-II-Project\\Crime-Detection\\img\\next.png")
...
def register(entries, required, menu_var):
    ...
    if(len(no_face) > 0):
        ...
        if(rowId >= 0):
            ...
            cv2.imwrite("C:/IV-II-Project/Crime-Detection/profile_pics/criminal %d.png"%profile_img_num,img)
...
def showCriminalProfile(name):
    ...
    path =("C:\\IV-II-Project\\Crime-Detection\\profile_pics\\criminal %d.png"%id)
...
logo = tk.PhotoImage(file = r"C:\IV-II-Project\Crime-Detection\img\logo2.png")
